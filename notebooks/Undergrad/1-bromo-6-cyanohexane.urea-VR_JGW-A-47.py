...
raw = pd.read_csv(r'../data/VR-DSC/1-bromo-6-cyanohexane.urea-VR_JGW-A-47.csv')
mass = 6.48 #in mg
...
# Get rid of outliers, see lab notebook
raw.drop([0, 3, 12], axis=0, inplace=True)

#Import and fit
df = LagCorrection(raw.iloc[:, 0:3], Therm_Resist, mass)
...
ax.set_title(r"1-bromo-6-cyanohexane/urea Guest Jump")
...
ax2.set_title(r"1-bromo-6-cyanohexane/urea Guest Jump")
plt.grid()
...
k_ax.set_title(r"1-bromo-6-cyanohexane/urea Guest Jump")
